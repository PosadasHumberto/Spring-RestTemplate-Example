...
import org.hposadas.springresttemplate.config.RestTemplateBuilderConfig;
...
public class BeerClientMockTest {
    ...
    void testUpdateBeer() {
        ...
        BeerDTO responseBeer = beerClient.updateBeer(beerDTO);

        assertThat(responseBeer.getId()).isEqualTo(beerDTO.getId());
    }
    ...
    private void mockGetOperation() {
        server.expect(method(HttpMethod.GET))
                .andExpect(requestToUriTemplate(
                        URL+BeerClientImpl.GET_BEER_BY_ID_PATH, beerDTO.getId()))
